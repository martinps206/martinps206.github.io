...
const Data = () => {
    return (
        <div className="home__data">
            ...
            Desarrollador de Software con 4 años de experiencia en Backend, especializado en Java, Node.js y sus frameworks. Enfocado en la integración de tecnologías y la resolución de desafíos técnicos complejos.            </p>
